...
fn slot_context(slot: SecretSlot) -> (&'static str, u8) {
    match slot {
        ...
        SecretSlot::BrowserHostEd25519SecretKeyV1 => ("browser-host-ed25519-secret-key-v1", 9),
        SecretSlot::BrowserHostLifecycleTokenV1 => ("browser-host-lifecycle-token-v1", 10),
