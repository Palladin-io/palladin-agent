...
mod tests {
    ...
    use super::{
        ...
        decrypt_full_credential_at, decrypt_full_script_member_secret, normalize_grant_payload,
        parse_nonzero_u64, parse_uuid, to_descriptor, verify_agent_wrapped_vault_key_producer,
    };
    use crate::{
