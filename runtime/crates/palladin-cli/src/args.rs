...
pub enum Commands {
    ...
    Connect(ConnectArgs),
    /// Pair an Agent in the system browser without exposing an API key.
    PairAgent(PairAgentArgs),
...
#[derive(Debug, Args)]
pub struct PairAgentArgs {
    /// Palladin API base URL.
    #[arg(long, default_value = "https://api.palladin.io")]
    pub host: String,
    /// Canonical value-free setup descriptor generated by Palladin Add Agent.
    #[arg(long)]
    pub setup_descriptor: Option<String>,
    /// Optional display name declaration. When the descriptor carries a name, it must match.
    #[arg(long)]
    pub display_name: Option<String>,
    /// Optional free-form Agent type metadata.
    #[arg(long)]
    pub r#type: Option<String>,
}
...
pub enum McpCommand {
    ...
    Serve {
        /// API host used only when pair_agent creates an unconfigured profile.
        #[arg(long, default_value = "https://api.palladin.io")]
        host: String,
    },
}
